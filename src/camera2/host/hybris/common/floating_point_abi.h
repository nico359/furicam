...
/* Vendored verbatim from libhybris (Apache-2.0) so that Camera2NDKShim.c
 * compiles on hosts without libhybris-dev installed (e.g. the Debian desktop
 * used for fast build iteration).  On the FuriPhone the system copy under
 * /usr/include/hybris/common/ is identical. */
